...
-  you have to have an intermediary table that contains the foreign keys from both parent tables involved. That is what allows you to make that connection.
